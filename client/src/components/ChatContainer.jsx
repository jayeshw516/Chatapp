  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur'>
      ...
      <div className='flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6'>
        {messages.map((msg, index)=>(
            ...
            {msg.image ? (
                ...
                <p className={`p-2 max-w-[200px] md:text-sm font-light rounded-lg mb-8 break-all bg-violet-500/100 text-white ${msg.senderId === authUser._id ? 'rounded-br-none' : 'rounded-bl-none'}`}>{msg.text}</p>
            )}
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
        ...
        <img onClick={handleSendMessage} src={assets.SendButton} alt="" className='w-7 cursor-pointer'/>
      </div>
    ...
    <div className='flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden'>
        <img src={assets.chatNew} className='max-w-30' alt=""/>
